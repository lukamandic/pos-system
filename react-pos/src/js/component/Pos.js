            ...
            <div>
                ...
                <div class="container">
                    <div class="text-center">
                        ...
                        <div>
                            <button class="btn btn-success lead"
                            id="checkoutButton"
                                ...
                                <Modal.Body>
                                    <div ng-hide="transactionComplete" class="lead">
                                        ...
                                        >
                                            ...
                                            <div class="lead" />
                                            <Button class="btn btn-primary btn-lg lead"
                            ...
                            <tr>
                                <td colspan="6" class="text-center">
                                    <span class="pull-left">
                                        <button onClick={() => this.setState({ addItemModal: true })}
                                        class="btn btn-default btn-sm">
                                        <i class="glyphicon glyphicon-plus" /> Add Item
                                        </button>
                                    </span>
                                    <Modal show={this.state.adItemModal} onHide={this.close}>
                                        <Modal.Header closeButton>
                                            <Modal.Title>Add Item(Product)</Modal.Title>
                                        </Modal.Header>
                                        <Modal.Body>
                                            <form ref="form" onSubmit={this.handleSubmit} class="form-horizontal">
                                                    <div class="form-group">
