...
class LiveCart extends Component {
    ...
    render() {
        let { transactions, liveTransactions } = this.state;
        let renderRecentTransactions = () => {
                ...
                <div class="livecart">
                    <div class="col-md-5 pull-right">
                        <div class="panel panel-primary">
                            <div class="receipt table table-hover">
                            {renderDate()}
                            </div>
